...
As explained in Section \@ref(inputelements), these input elements are contained in the `ti_input_elements` datatable to avoid their hardcoding in the plugins.
...
Each of the $9$ elements correspond to a different indicator. The BTD has two different forms -- for when the reporter country acts either as an importing or as an exporting country -- so two subelements are created: $504.01$ and $504.02$, respectively. The other two subelements of element $504$, which are $504.\text{d}1$ and $504.\text{d}2,$ are used to (possibly) include the corresponding differences between imports and exports; they are computed as the numerator of Equation (2.4) and Equation (2.5), respectively. Finally, since RCA is calculated for each commodity for both the agricultural aggregates T0010 and F1882, subelements $509.01$ (for aggregate T0010) and $509.02$ (for aggregate F1882) are also introduced.
  
    **Code**                      **Description**                    **Unit**  
  -----------------  -------------------------------------------  ----------- 
    $501$                      Import Dependency Ratio             Unitless    
    $502$                       Self-Sufficiency Ratio             Unitless    
    $503$              Share of Agricultural Exports to GDP        $\%$    
    $504$                Bilateral Trade Discrepancy               Index
    $504.01$           Bilateral Trade Discrepancy - Importer      Index
    $504.\text{d}1$         BT difference - Importer               $1000\$$ 
    $504.02$           Bilateral Trade Discrepancy - Exporter      Index
    $504.\text{d}2$         BT difference - Exporter               $1000\$$ 
    $505$                 Agricultural Trade Openness              Index    
    $506$                       Terms of Trade                     $\%$    
    $507$                 Import Market Concentration              Index    
    $508$                 Export Market Concentration              Index    
    $509$               Revealed Comparative Advantage             Index  
    $509.01$           Revealed Comparative Advantage - T0010      Index
    $509.02$           Revealed Comparative Advantage - F1882      Index
